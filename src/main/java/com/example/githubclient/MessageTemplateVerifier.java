...
public class MessageTemplateVerifier {
    ...
    private static String PATTERN = "^((LEETCODE|ITERATOR|DESIGN|GENERATOR|TRIANGLE)-(2021|2022)).+";
    private static String NOT_OK_RESULT = "title should start with GENERATOR, LEETCODE, DESIGN, ITERATOR OR TRIANGLE," +
